...
local ScanTime = 1 -- Change time of each scan (disco mode?) [yes 0 works, no, it wont crash]
-- Change how far radar should check for players
local PlayerDetectionRadius = 75
local ExecutiveDetectionRadius = 2000
local PlaneDetectionRadius = 4000

local RadarSize = .5 -- Change radar size
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.35, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.49, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(76, 255, 0)), ColorSequenceKeypoint.new(0.54, Color3.fromRGB(46, 170, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}

UIGradient.Offset = Vector2.new(1,-0.4)
...
local function NEGNSX()
  ...
  local Results;Results=Track:Connect(function()
